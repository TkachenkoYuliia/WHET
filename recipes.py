...
INGREDIENT_ALIASES = {
    ...
    "вівсянка": ["вівсянка", "вівсяні пластівці", "овсянка", "oats", "oatmeal", "rolled oats"],
...
def ingredient_keys_formatted() -> str:
    """Bullet list of canonical ingredient keys from INGREDIENT_ALIASES."""
    return "\n".join(f"• {k}" for k in sorted(INGREDIENT_ALIASES.keys()))
